...
complex complexAdd(complex a, complex b) {
    ...
    return new; // CHANGE THIS TO YOUR RETURN VALUE
}
...
complex complexMultiply(complex a, complex b) {
    ...
    new.imaginary = a.imaginary * b.real + a.real * b.imaginary;
    return new; // CHANGE THIS TO YOUR RETURN VALUE
}
...
complex complexSquare(complex c) {
    // PUT YOUR CODE HERE;
    complex new;
    new.real = c.real * c.real - c.imaginary * c.imaginary;
    new.imaginary = c.imaginary * c.real + c.real * c.imaginary;
